...
$$
V\left(t\right)=V\left(\infty\right)+\left\lbrack V\left(0\right)-V_{\infty}\right\rbrack\cdot e^{-t/\tau}
$$

$$
I\left(t\right)=I_{SC}+\left\lbrack I\left(0\right)-I_{SC}\right\rbrack\cdot e^{-t/\tau}
$$
...
$$
i_{c}=C\cdot\frac{\mathrm{d}v_c}{\mathrm{d}t}
$$

$$
V_{L}=L\cdot\frac{\mathrm{d}i_L}{\mathrm{d}t}
$$
